...
public class PhotonManager : MonoBehaviourPunCallbacks //PUN의 다양한 콜백 함수를 오버라이드해서 작성
{
    ...
    public override void OnJoinedRoom()
    {
        ...
        //AssignPlayerNumber(PhotonNetwork.LocalPlayer.ActorNumber);
    ...
    {
        PhotonView pv = PhotonView.Get(this);
        //AssignPlayerNumber(newPlayer.ActorNumber);
    ...
    void Create(int assignedNumber)
    {
        ...
        pLaYeR.GetComponent<PlayerData>().playerNum = assignedNumber;
        Debug.Log("만든 플레이엉");
