...
public class RandomSpawn : MonoBehaviour
{
    ...
    [Space(10f)]
    [Header("스폰할 물건들")]
    public string[] SpawnObject;        //생성할 물건들
    ...
    void Spawn()                //생성작업
    {
        ...
        if (sCount.Length < limitSpawn || limitSpawn == 0)
        {
            ...
            GameObject Spawn = PhotonNetwork.Instantiate(SpawnObject[randomIndex], axis, Quaternion.identity);
            Spawn.transform.localEulerAngles = new Vector3(0, Random.Range(-180 , 180) , 0);
        }
    }
}
